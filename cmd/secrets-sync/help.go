...
COMMANDS:
    ...
    convert     Convert external-secrets YAML to secrets-sync format
...
EXAMPLES:
    ...
    # Convert external-secrets to secrets-sync format
...
For more information, see: https://github.com/ohauer/secrets-sync
`)
}
